    ...
    <div className="mt-20">
      <div className="w-full mx-auto h-full relative  items-center justify-center rounded-md">
        ...
        <div className="grid lg:grid-cols-4 grid-cols-3  justify-center w-10/12  mx-auto md:mt-10">
          ...
          <div className="flex flex-col lg:hidden md:col-span-2 col-span-3 ">
            ...
            <HeroHighlight>
              <motion.h1
                ...
                className="text-start tracking-wide font-normal md:text-base sm:text-sm text-sm text-neutral-400 md:w-11/12 w-full mx-auto"
              >
          ...
          <div className="md:flex hidden flex-col gap-2 lg:mt-0 my-16 mx-auto">
          ...
          <div className="md:flex hidden flex-col gap-2 lg:mt-0 mt-16">
