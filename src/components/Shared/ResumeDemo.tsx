...
export function ResumeDemo() {
    return (
        <div className="md:w-10/12 w-11/12 md:p-0 p-1 mx-auto md:tracking-wide tracking-normal opacity-90">
            <h1 className="sm:text-center text-center md:text-3xl text-xl font-normal mt-10">Patel Mitenkumar Mukeshbhai</h1>
